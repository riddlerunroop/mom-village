// Rediscover — shared category taxonomy, 2026-09-19. Verbatim port of
// src/lib/rediscoverCategories.ts — keep both in sync if this ever changes.
//
...
// not listed anywhere below. Do not add a "Legal", "Financial Advisory",
// "Investment", or "Medical/Health Advice" tag without her own legal review
// first.
...
// each just links into browsing that category.
